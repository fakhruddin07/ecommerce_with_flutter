import 'package:ecommerce_with_flutter/data/models/payment_method.dart';
import 'package:ecommerce_with_flutter/presentation/state_holders/create_invoice_controller.dart';
import 'package:ecommerce_with_flutter/presentation/ui/screens/webview_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<CreateInvoiceController>(builder: (controller) {
        ...
        if(!isCompleted){
          return const Center(child: Text("Please complete your profile first."),);
        }
